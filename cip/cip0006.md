...
- [x] **COMPLETED: Coverage Improvement** (2025-10-12)
  - [x] Improved coverage from 78% to 95% (+17 percentage points)
  - [x] Reduced missing lines from 191 to 44 (-147 lines)
...
**Current Coverage**: 95% (904/948 statements) - **ACHIEVED through systematic test additions**
**Target Coverage**: 95%+ before refactoring - **ACHIEVED**

**Critical Missing Lines** (44 uncovered statements) - **Organized by Test File:**
...
- ~~Lines 573, 575-579, 583: LM set_param method~~ ✅ **COVERED**

## test_linear_models.py (Linear Models & Basis Functions)
- ~~Line 537: LM constructor error handling~~ ✅ **COVERED**
- ~~Lines 654-655, 659-660: Linear model objective/log_likelihood edge cases~~ ✅ **COVERED**
- ~~Lines 783-785: radial function single basis branch~~ ✅ **COVERED**
- ~~Line 825: fourier function with frequency_range~~ ✅ **COVERED**
- ~~Lines 858-861, 863: relu function edge cases~~ ✅ **COVERED**
- ~~Lines 902-907: relu function additional edge cases~~ ✅ **COVERED**
- ~~Lines 2295-2298: LR predict method~~ ✅ **COVERED**
- ~~Lines 2325-2335: LR fit method and convergence~~ ✅ **COVERED**
- ~~Lines 573, 578-579, 583: LM set_param method~~ ✅ **COVERED**
- ~~Lines 2105, 2112-2113: BLM set_param method~~ ✅ **COVERED**

## test_gaussian_processes.py (Gaussian Processes)
- ~~Lines 1091, 1093: NonparametricDropoutNeuralNetwork error handling~~ ✅ **COVERED** (moved to experimental)
- ~~Lines 2431-2432, 2438: GP nll_split method~~ ✅ **COVERED**
- ~~Lines 2447-2448: GP log_likelihood method~~ ✅ **COVERED**
- ~~Line 2457: GP objective method~~ ✅ **COVERED**
- ~~Line 2549: Kernel K method~~ ✅ **COVERED**
- ~~Lines 2608-2609: OU covariance function~~ ✅ **COVERED**
- ~~Lines 2670-2674: ReLU covariance function~~ ✅ **COVERED**
- Lines 2549, 2608-2609, 2670-2674: GP optimization edge cases
- Lines 2783-2786, 2801-2804: Kernel/covariance functions (add_cov, prod_kern) ✅ **MOVED FROM test_utils.py**
...
- ~~Lines 1617-1640: finite_difference_jacobian function~~ ✅ **COVERED**
- ~~Lines 1539-1591: finite_difference_gradient function~~ ✅ **COVERED**
- Lines 2251-2252, 2278: Data generation utility functions (load_pgm error handling, LR constructor error handling)
- Lines 3132-3154, 3184, 3191-3192: Mathematical utility functions (radial_multivariate, dist2)
- Lines 3417-3423: Data generation utility functions (generate_swiss_roll)


## test_dimred.py (Dimensionality Reduction & Clustering)
- Lines 3196-3202, 3207-3216: Clustering algorithms (kmeans_assignments, kmeans_update) ✅ **MOVED FROM test_utils.py**
- ~~Lines 3172-3181: kmeans_objective function~~ ✅ **COVERED**
- Lines 3227-3236, 3242-3252, 3258-3274, 3280-3307, 3313-3331, 3337-3363: Ward's method edge cases
- ~~Lines 3351: ppca_eig function~~ ✅ **COVERED**
- ~~Lines 3366: ppca_svd function~~ ✅ **COVERED**
- Lines 3368-3378, 3383-3394, 3398-3405, 3410-3412: Dimensionality reduction algorithms (ppca_posterior, kruskal_stress) ✅ **MOVED FROM test_utils.py**

## test_experimental.py (Experimental Features)
- ~~Lines 1091, 1093: NonparametricDropoutNeuralNetwork error handling~~ ✅ **COVERED**
